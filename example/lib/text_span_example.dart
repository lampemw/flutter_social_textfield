...
class SocialTextSpanExampleScreen extends StatefulWidget {
  @override
  _SocialTextSpanExampleScreenState createState() =>
      _SocialTextSpanExampleScreenState();
}

class _SocialTextSpanExampleScreenState
    extends State<SocialTextSpanExampleScreen> {
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Text(
                "You can also use SocialTextSpanBuilder as a text formatter,and now it also supports click actions!",
            ...
            Padding(
              padding: const EdgeInsets.fromLTRB(0, 8, 0, 16),
              child: Text(
                "Tap on a detection to see what happens!",
            ...
            RichText(
              text: SocialTextSpanBuilder(
                  ...
                  detectionTextStyles: {
                    DetectedType.mention: DetectionTextStyle(
                        validTextStyle: TextStyle(
                            color: Colors.purple,
                            backgroundColor: Colors.purple.withAlpha(50))),
                    DetectedType.hashtag: DetectionTextStyle(
                        validTextStyle: TextStyle(
                            color: Colors.blue,
                            decoration: TextDecoration.underline)),
                    DetectedType.url: DetectionTextStyle(
                        validTextStyle: TextStyle(
